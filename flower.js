...
var doc = document;
var flower = 
    doc.querySelector('.flower');
var range =
    doc.querySelector('.range');
...
var partsFrontStepDef = 25 / maxParts;
var hueStep = 150 / maxParts;
...
function createBox(box, pos) {
  ...
  var color = 'hsl(' + hueStep * pos + ', 100%, ' + bright + '%)';
